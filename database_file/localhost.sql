...
(0, 0, 21232, '', '', '2020-06-26 17:25:20', '1');
...
(1, '小松数管系统', '数据管理，题库系统,网课搜题', '黔备ICP1343651', '这是一款非常强大的数据管理系统，能让你可视化的管理你的数据', '2020小松科技版权©️所有，仿冒必究');
...
ALTER TABLE `xs_bank1`
  MODIFY `ID` int(16) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
COMMIT;
