<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/storage/emulated/0/wwwroot/public/../application/admin/view/wechat.html";i:1600846162;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600846124;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<form action="<?php echo url('admin/Wechat/wechat_site_Revise'); ?>" method="post" class="form-horizontal">

                             
                                                               <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">开关设置:</label>
                                      <div class="col-lg-10">
                                   ...
                                   <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">对接url:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="abutment_url" value="<?php echo $abutment_url; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">对接token:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="abutment_token" value="<?php echo $abutment_token; ?>">
                                      </div>
                                  </div>
                                   ...
                                   <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">关注回复:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="focus_reply" value="<?php echo $focus_reply; ?>">
                                      </div>
                           </div>
                                   ...
                                   <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">无资源回复:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="noResource_reply" value="<?php echo $noResource_reply; ?>">
                                      </div>
                                  </div>
                                   ...
                                   <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">自定义关键词:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="defined_keyword1" value="<?php echo $defined_keyword1; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">自定义关键词:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="defined_keyword2" value="<?php echo $defined_keyword2; ?>">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">自定义关键词:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" name="defined_keyword3" value="<?php echo $defined_keyword3; ?>">
                                      </div>
                                  </div>
