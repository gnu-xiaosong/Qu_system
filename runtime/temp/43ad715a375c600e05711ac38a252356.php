<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/storage/emulated/0/wwwroot/public/../application/admin/view/setadmin.html";i:1600845948;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600846124;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              ...
                              <div class="alert alert-block alert-danger fade in">
                                  ...
                                  <strong>哈哈</strong> 美好的一天从今天开始
                              </div>
                              <div class="alert alert-success fade in">
                                  <button data-dismiss="alert" class="close close-sm" type="button">
                                      <i class="icon-remove"></i>
                                  </button>
                                  <strong>寄语!</strong> 你我将有无限可能.
                              </div>
                          ...
                          <div class="panel-body">
                              <form class="form-inline" role="form">
                                  <div class="form-group">
                                      <label class="sr-only" for="exampleInputEmail2">管理员账号:</label>
                                      <input type="email" class="form-control" id="exampleInputEmail2" placeholder="管理员账号">
                                  </div>
                                  <div class="form-group">
                                      <label class="sr-only" for="exampleInputPassword2">管理员密码:</label>
                                      <input type="password" class="form-control" id="exampleInputPassword2" placeholder="管理员密码">
                                  </div>
                                  <div class="checkbox">
                                      <label>
