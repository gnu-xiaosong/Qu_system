<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"/storage/emulated/0/wwwroot/public/../application/admin/view/payroad.html";i:1600846055;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600841730;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form">
                                  ...
                                  <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">支付宝:</label>
                                      <div class="col-lg-10">
                                        <select class="form-control input-lg m-bot15" name="payroads1" value="">
                                              <option>官方支付宝</option>
                                              <option>当面付</option>
                                              <option>微信</option>
                                              <option>QQ</option>
                                     ...
                                     <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">微信:</label>
                                      <div class="col-lg-10">
                                        <select class="form-control input-lg m-bot15" name="payroads2" value="">
                                              <option>官方支付宝</option>
                                              <option>当面付</option>
                                              <option>微信</option>
                                              <option>QQ</option>
                                     ...
                                     <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">QQ:</label>
                                      <div class="col-lg-10">
                                        <select class="form-control input-lg m-bot15" name="payroads3" value="">
                                              <option>官方支付宝</option>
                                              <option>当面付</option>
                                              <option>微信</option>
                                              <option>QQ</option>
