<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"/storage/emulated/0/wwwroot/public/../application/admin/view/question.html";i:1600846154;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600846124;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
     ...
     <!--题库一-->
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <div class="row">
                                  <div class="bio-row">
                                      <p><span>数据库 </span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>数据库表 </span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>所在区域 </span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>题库总量</span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>数据库使用率 </span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>题目类型</span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>总连接用户数</span>: 暂定</p>
                                  </div>
                                  <div class="bio-row">
                                      <p><span>调用总数</span>: 暂定</p>
                                  </div>
                              </div>
                          </div>
                      </section>
                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone"><i class="icon-question-sign"></i> 备注</th>
                                  <th><i class="icon-bookmark"></i> 调用次数</th>
                              ...
                              <tr>
                                  <td><a href="#">用户1</a></td>
                                  <td class="hidden-phone">会员</td>
                                  <td>1800次 </td>
                                  <td><span class="label label-info label-mini">在线</span></td>
                                  <td>
