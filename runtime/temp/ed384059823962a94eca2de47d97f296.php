<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/storage/emulated/0/wwwroot/public/../application/admin/view/site.html";i:1600845986;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600841730;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <div class="col-lg-12">
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <form action="<?php echo url('admin/Site/siteRevise'); ?>" method="post" class="form-horizontal">
                                      
                                          <div class="form-group">
                                              <label class="col-sm-2 col-sm-2 control-label">网站名称:</label>
                                              <div class="col-sm-10">
                                                  <input type="text"  name="web_title" value="<?php echo $web_title; ?>"  class="form-control">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_log" value=""  class="form-control">
                                                  <span class="help-inline"><br></span>
                                              </div>
                                          </div>
                                          
                                          <div class="form-group">
                                              <label class="col-sm-2 control-label">站点ULR:</label>
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_url"  value="<?php echo $_SERVER['HTTP_HOST']
                                                  ?>" class="form-control">
                                                  <span class="help-inline"> 系统已自动检测到您的域名<br></span>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_beian"  value="<?php echo $web_beian; ?>" class="form-control">
                                                  <span class="help-inline"><br></span>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_description"  value="<?php echo $web_description; ?>" class="form-control">
                                                  <span class="help-inline"><br></span>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_keyword"  value="<?php echo $web_keyword; ?>" class="form-control">
                                                  <span class="help-inline"><br></span>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-10">
                                                  <input type="text" name="web_copyright"  value="<?php echo $web_copyright; ?>" class="form-control">
                                                  <span class="help-inline"><br></span>
                                              </div>
                                          </div>
