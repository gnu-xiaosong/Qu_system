<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/storage/emulated/0/wwwroot/public/../application/admin/view/email.html";i:1600845917;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600841730;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <section id="main-content">
         ...
         <section class="panel">
                          ...
                          <div class="panel-body">
                              <form name="myForm" onsubmit="return email();"  class="form-horizontal" role="form">
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">SMTP:</label>
                                      <div class="col-lg-10">
                                          <input type="email" class="form-control" name="smtp" value="" placeholder="请填写SMTP服务器地址">
                                  ...
                                  <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">SMTP端口:</label>
                                      <div class="col-lg-10">
                                          <input type="password" class="form-control" name="" value="" placeholder="端口">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">邮箱账号:</label>
                                      <div class="col-lg-10">
                                          <input type="password" class="form-control" name="zhang" value="" placeholder="填写邮箱账号">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">邮箱授权码:</label>
                                      <div class="col-lg-10">
                                          <input type="password" class="form-control" name="shou" value="" placeholder="授权码">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label" name="email" value="">收件邮箱:</label>
                                      <div class="col-lg-10">
                                          <input type="password" class="form-control" name="shouemail" value="" placeholder="填写收件邮箱">
                                      </div>
                                  </div>
                                  
                                     <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                          <button type="submit" onlick="">发信测试</button>
                                      </div>
                                  </div>
