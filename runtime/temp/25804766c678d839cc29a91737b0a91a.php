<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/storage/emulated/0/wwwroot/public/../application/admin/view/chit.html";i:1600846013;s:62:"/storage/emulated/0/wwwroot/application/admin/view/header.html";i:1600841730;s:61:"/storage/emulated/0/wwwroot/application/admin/view/aside.html";i:1600841730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <div class="panel-body">
                              ...
                              <form class="form-horizontal tasi-form" method="get">
                                  <div class="form-group has-success">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">短信接口:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="inputSuccess">
                                      </div>
                                  </div>
                                  <div class="form-group has-warning">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputWarning">短信秘钥:</label>
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="inputWarning">
                                      </div>
                                  </div>
                                  <div class="form-group has-error">
                                      <label class="col-sm-2 control-label col-lg-2" for="inputError">短信模板:</label>
                                      <div class="col-lg-10">
